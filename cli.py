...
import sys
import click
from engine import ClockworkResult
...
@click.option('--fast', is_flag=True,
              help='Use the JIT-optimized fast engine')
def main(code_path: str, test_path: str, debug: bool, verbose: bool, fast: bool):
    if fast:
        from fast_engine import ClockworkEngine
    else:
